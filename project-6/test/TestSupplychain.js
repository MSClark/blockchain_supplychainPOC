...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferOne[4].toNumber(), web3.fromWei(productPrice, 'ether'), 'Error: Invalid item productPrice')
        assert.equal(resultBufferOne[5].toNumber(), 7, 'Error: Invalid item itemState')
